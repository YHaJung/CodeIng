(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-google-analytics', ['exports', '@angular/core', '@angular/common', '@angular/router', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-google-analytics'] = {}, global.ng.core, global.ng.common, global.ng.router, global.rxjs.operators));
}(this, (function (exports, i0, i2, router, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var GaEventDirective = /** @class */ (function () {
        function GaEventDirective(gaCategoryDirective, gaService, settings) {
            this.gaCategoryDirective = gaCategoryDirective;
            this.gaService = gaService;
            this.settings = settings;
            this.gaBind = 'click';
        }
        GaEventDirective.prototype.ngOnInit = function () {
        };
        GaEventDirective.prototype.onClick = function () {
            if (this.gaBind === 'click') {
                this.trigger();
            }
        };
        GaEventDirective.prototype.onFocus = function () {
            if (this.gaBind === 'focus') {
                this.trigger();
            }
        };
        GaEventDirective.prototype.onBlur = function () {
            if (this.gaBind === 'blur') {
                this.trigger();
            }
        };
    ...
    var NgxGoogleAnalyticsModule = /** @class */ (function () {
         ...
         */
        NgxGoogleAnalyticsModule.forRoot = function (trackingCode, commands, uri, enableTracing, nonce) {
